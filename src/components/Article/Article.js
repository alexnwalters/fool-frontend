...
class Article extends Component {
    render() {
        return(
            <div>
                <div>
                    <h1 className='hero'>Stock Advisor</h1> 
                    <p>
                        ...
                        David and Tom have put together a heck of a run. And since I have the luxury of working with them, I know what they’re most proud of is their ability to consistently lead investors to some of the most life-changing investment returns the market has ever seen.
                    </p>
                </div>
                <div>
                    <h2>I’m talking, of course, about companies like:</h2>
                    <Recs />
                    <p>
                ...
                <div>
                    <p>Of course, neither David or Tom would ever describe this stock as a “sure thing,” but the details behind this tiny little internet company are impressive:</p>
                    <ul>
                        <li>It’s 1/100th the size of Google.</li>
                        <li>Each one of David’s and Tom’s recommendations of its stock is crushing the market.</li>
                        <li>Its young CEO has already banked $916 million on this stock since its IPO.</li>
                    </ul>
                    <p>
                ...
                <div>
                    <h2>And here’s the real kicker…</h2>
                    <p>
